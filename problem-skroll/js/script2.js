...
var models = [
    ...
    {model:"FH6G1BCH2N",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05898576",linkMore:"кккккккккк/ru/washing-machines/lg-FH6G1BCH2N", drumModel:"TW202W", drumLink:"кккккккккк/ru/washing-machines/lg-TW202W", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014517&returnFlag=",bullits:["Загрузка: 10.5 кг","Габариты (Ш × Г × В, мм):<br> 600 x 640 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 2 кг","Габариты (Ш × Г × В, мм):<br> 595 × 659 × 360", "Гарантия 10 лет"]},
    {model:"FH6G1BCH6N",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05902436",linkMore:"кккккккккк/ru/washing-machines/lg-TW206W", drumModel:"TW206W", drumLink:"кккккккккк/ru/washing-machines/lg-FH8G1MINI6", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014996",bullits:["Загрузка: 10.5 кг","Габариты (Ш × Г × В, мм):<br> 500 x 640 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 2 кг","Габариты (Ш × Г × В, мм):<br> 595 × 659 × 364", "Гарантия 10 лет"]},
    {model:"FH495BDS2",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05763493",linkMore:"кккккккккк/ru/washing-machines/lg-FH495BDS2", drumModel:"TW202W", drumLink:"кккккккккк/ru/washing-machines/lg-TW202W", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014517&returnFlag=",bullits:["Загрузка: 12 кг","Габариты (Ш × Г × В, мм):<br> 600 x 640 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 2 кг","Габариты (Ш × Г × В, мм):<br> 595 × 659 × 364", "Гарантия 10 лет"]},
    {model:"FH495BDS6",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05786069",linkMore:"кккккккккк/ru/washing-machines/lg-FH495BDS6", drumModel:"TW206W", drumLink:"кккккккккк/ru/washing-machines/lg-TW206W", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014996",bullits:["Загрузка: 12 кг","Габариты (Ш × Г × В, мм):<br> 600 x 640 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 3.5 кг","Габариты (Ш × Г × В, мм):<br> 595 × 659 × 364", "Гарантия 10 лет"]},
    {model:"FH695BDH6N",linkWtb:"http://www.lg.com/ru/products/wtb?modelId=MD05785009",linkMore:"http://www.lg.com/ru/washing-machines/lg-FH695BDH6N", drumModel:"TW206W", drumLink:"кккккккккк/ru/washing-machines/lg-TW206W", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014996",bullits:["Загрузка: 12 кг","Габариты (Ш × Г × В, мм):<br> 600 x 640 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 2 кг","Габариты (Ш × Г × В, мм):<br> 595 × 659 × 364", "Гарантия 10 лет"]},
    {model:"F1K2CH2T",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05764167",linkMore:"кккккккккк/ru/washing-machines/lg-F1K2CH2T", drumModel:"TW351W", drumLink:"", drumWtb:"",bullits:["Загрузка: 17 кг","Габариты (Ш × Г × В, мм):<br> 700 × 770 × 990", "Гарантия 10 лет"],drumBullits:["Загрузка: 3.5 кг","Габариты (Ш × Г × В, мм):<br> 700 x 770 x 360", "Гарантия 10 лет"]},
    {model:"TW7000DS",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05856441",linkMore:"кккккккккк/ru/washing-machines/lg-TW7000DS", drumModel:"TW351W", drumLink:"", drumWtb:"",bullits:["Загрузка: 17 кг","Габариты (Ш × Г × В, мм):<br> 700 × 770 × 990", "Гарантия 10 лет"],drumBullits:["Загрузка: 3.5 кг","Габариты (Ш × Г × В, мм):<br> 700 x 770 x 360", "Гарантия 10 лет"]},
    {model:"FH4G1JCH2N",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05904556&returnFlag=",linkMore:"кккккккккк/ru/washing-machines/lg-FH4G1JCH2N", drumModel:"TW202W", drumLink:"кккккккккк/ru/washing-machines/lg-TW202W", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014517&returnFlag=",bullits:["Загрузка: 10.5 кг","Габариты (Ш × Г × В, мм):<br> 600 x 640 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 2 кг","Габариты (Ш × Г × В, мм):<br> 600 × 700 × 365", "Гарантия 10 лет"]},
    {model:"TW4J8JH2W",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD05988796&returnFlag=",linkMore:"кккккккккк/ru/washing-machines/lg-TW4J8JH2W", drumModel:"TW202W", drumLink:"кккккккккк/ru/washing-machines/lg-TW202W", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014517&returnFlag=",bullits:["Загрузка: 10.5 кг","Габариты (Ш × Г × В, мм):<br> 600 x 610 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 2 кг","Габариты (Ш × Г × В, мм):<br> 600 × 700 × 365", "Гарантия 10 лет"]},
    {model:"TW4J7VS2W",linkWtb:"кккккккккк/ru/products/wtb?modelId=MD06014857&returnFlag=",linkMore:"кккккккккк/ru/washing-machines/lg-TW4J7VS2W", drumModel:"TW202W", drumLink:"кккккккккк/ru/washing-machines/lg-TW202W", drumWtb:"кккккккккк/ru/products/wtb?modelId=MD06014517&returnFlag=",bullits:["Загрузка: 9.5 кг","Габариты (Ш × Г × В, мм):<br> 600 x 560 x 850", "Гарантия 10 лет"],drumBullits:["Загрузка: 2 кг","Габариты (Ш × Г × В, мм):<br> 600 × 700 × 365", "Гарантия 10 лет"]}
]
...
function pointAnim() {
    ...
    // if(($(document).scrollTop() > ($('.product-image-block').offset().top - $(window).height()/2) )) {
    //     wWm =  (($(document).scrollTop() + $(window).height()/2)  - $('.product-image-block').offset().top)*stepWm;
    //     if (wWm > $('.product-image-block img').width()*0.6) {
    //         wWm = $('.product-image-block img').width()*0.6;
    //     }
    //     if($(document).scrollTop() == 0 ) {
    //         opWm = 0;
    //     } else {
    //         opWm = ($(document).scrollTop()+$(window).height()/2 - $('.product-image-block').offset().top)/300-0.25;
    //     }
    //     $('.product-image-block').css({opacity:opWm});
    //     $('.wm-circle').css({opacity:1-opWm});
    //     $('.wm-circle').css({width:wWm,height:wWm});
...
var models = [
    ...
    $.ajax({
        url: "https://gethatch.com/iceleads_rest/affiliate/"+BU+"/json",
        dataType: "jsonp",
        type: "GET",
        jsonp: 'callback',
        data: {region: "RU", mpn: mpn, callback:"success"},
        success: function(data){
            if (data.iceleads_interface.status === 200) {
                var shops = data.iceleads_interface.retailers.retailer;
                for (var i = 0; i < shops.length; i++) {
                    if (shops[i].stock_qty > 0){
                        if(shops[i].id == '91239') {
                            $('.wtb-popup-top .wtb-popup-content').prepend('<div class="shop"><a href="'+shops[i].purchase_link+'&cid=test_campaign|example_source" data-shopname="'+shops[i].name+'" data-site="'+shops[i].name+'" adobe-online="online-retailer" adobe-onlinename="'+shops[i].name+'" data-model="'+models[model].model+'" target="_blank"><img src="'+shops[i].logo+'" alt="'+shops[i].name+'"></a></div>');
                        } else {
                            $('.wtb-popup-top .wtb-popup-content').append('<div class="shop"><a href="'+shops[i].purchase_link+'" data-shopname="'+shops[i].name+'" data-site="'+shops[i].name+'" adobe-online="online-retailer" adobe-onlinename="'+shops[i].name+'" data-model="'+models[model].model+'" target="_blank"><img src="'+shops[i].logo+'" alt="'+shops[i].name+'"></a></div>');
                        }
                    }
                }
            } else {
                 $('.wtb-popup-top .wtb-popup-content').html('Модель пока что недоступна в магазинах');
            }
        }
    });
    $.ajax({
        ...
        type: "GET",
        jsonp: 'callback',
        data: {region: "RU", mpn: mpnDrum, callback:"success"},
        success: function(data){
            if (data.iceleads_interface.status === 200) {
                var shops = data.iceleads_interface.retailers.retailer;
                for (var i = 0; i < shops.length; i++) {
                    if (shops[i].stock_qty > 0){
                        if(shops[i].id == '91239') {
                            $('.wtb-popup-bottom .wtb-popup-content').prepend('<div class="shop"><a href="'+shops[i].purchase_link+'&cid=test_campaign|example_source" data-shopname="'+shops[i].name+'" data-site="'+shops[i].name+'" adobe-online="online-retailer" adobe-onlinename="'+shops[i].name+'" data-model="'+models[model].drumModel+'" target="_blank"><img src="'+shops[i].logo+'" alt="'+shops[i].name+'"></a></div>');
                        } else {
                            $('.wtb-popup-bottom .wtb-popup-content').append('<div class="shop"><a href="'+shops[i].purchase_link+'" data-shopname="'+shops[i].name+'" data-site="'+shops[i].name+'" adobe-online="online-retailer" adobe-onlinename="'+shops[i].name+'" data-model="'+models[model].drumModel+'" target="_blank"><img src="'+shops[i].logo+'" alt="'+shops[i].name+'"></a></div>');
                        }
                    }
                }
            } else {
                 $('.wtb-popup-bottom .wtb-popup-content').html('Модель пока что недоступна в магазинах');
